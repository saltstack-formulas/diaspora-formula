...
.. |img_travis| image:: https://travis-ci.com/saltstack-formulas/diaspora-formula.svg?branch=master
   :alt: Travis CI Build Status
   :scale: 100%
   :target: https://travis-ci.com/saltstack-formulas/diaspora-formula
